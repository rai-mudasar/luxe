...
export default function HeroSection() {
  return (
    <div className='w-full bg-linear-to-r from-[#2C2321] to-[#38312C] flex flex-col pl-3 md:pl-15 pt-15 md:pt-32 pb-15 md:pb-32'>
        ...
        <div className='w-45 md:w-60 bg-[#C45A3C] text-white rounded-full flex justify-center items-center gap-2 px-4 py-3 md:py-5 mt-7 group hover:cursor-pointer'>
